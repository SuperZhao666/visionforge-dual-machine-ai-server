    ...
    return (
        ...
        SourceContract(
            ...
            required=(
                ...
                "Release requires 1-3 pinned RS256 public pair-credential keys.",
                ...
                "deployedDualMachinePairCredentialPublicKeyFile",
                "is reused for usage tickets and pair credentials",
            ...
            forbidden=(
                ...
                "VISIONFORGE_DUAL_MACHINE_PAIR_CREDENTIAL_PRIVATE_KEY",
                "PRIVATE KEY-----\" +",
            ),
        ),
        SourceContract(
        ...
        SourceContract(
            ...
            required=(
                ...
                "VFDUAL_DUAL_MACHINE_PAIR_CREDENTIAL_PUBLIC_KEYS_BASE64 is required",
            ...
            forbidden=(
                ...
                "VFDUAL_DUAL_MACHINE_PAIR_CREDENTIAL_PRIVATE_KEY",
                "PRIVATE KEY",
            ),
        ),
        SourceContract(
    ...
    inherited.extend((
        ...
        SourceContract(
            ...
            forbidden=(
                ...
                "authorization_start_host_before_activation",
                "卡密已保留。请先启动同一网络中的 VF Host 并完成认证，再点击激活。",
                "只更新设备绑定，不重复充值或扣时",
                "authorization_ready_detail",
                "输入卡密进行激活不会立刻扣费",
                "身份签名",
                "卡密与剩余时间",
                "主机配置包",
...
def _check_host_public_security_inputs(root: Path) -> CheckResult:
    ...
    required = (
        "VFDUAL_ENFORCE_HOST_RELEASE_SECURITY_INPUTS",
        "VFDUAL_DUAL_MACHINE_TICKET_PUBLIC_KEYS_BASE64",
        "VFDUAL_DUAL_MACHINE_PAIR_CREDENTIAL_PUBLIC_KEYS_BASE64",
