...
if not defined VFDUAL_DUAL_MACHINE_PAIR_CREDENTIAL_PUBLIC_KEYS_BASE64 (
  echo ERROR: VFDUAL_DUAL_MACHINE_PAIR_CREDENTIAL_PUBLIC_KEYS_BASE64 is required and must contain 1-3 public PEM files encoded as Base64.
  exit /b 1
)
